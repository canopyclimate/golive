...
func TestEscape(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			`<button onclick='alert(1/ /* json: error calling MarshalJSON for type *htmltmpl.badMarshaler: invalid character &#39;f&#39; looking for beginning of object key string */null in numbers)'>`,
		},
		{
			"jsMarshaler",
